...
import exececoes.ExececaoCustomizada;
...
public class Inicio {
	public static void main(String[] args) {
		...
		try {
		...
		catch (ExececaoCustomizada e) { // trata erros que programador nao preve
			...
			/*
			 * Finally é sempre usado quando você precisa executar um processo acontecendo
			 * erro ou nao no sistema
			 */
	...
	public  static void lerArquivo() throws ExececaoCustomizada {
		try {
			...
			throw new ExececaoCustomizada(e.getMessage());
		}
	}
}